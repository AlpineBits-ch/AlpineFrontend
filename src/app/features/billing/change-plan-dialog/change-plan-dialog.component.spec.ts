 ...
 *
 * <p>Not a literal `"$14.50"`: the components format in the reader's locale by design, and a spec
 * that pinned the symbol placement would be asserting the test runner's ICU data rather than
 * anything this dialog does.</p>
 */
