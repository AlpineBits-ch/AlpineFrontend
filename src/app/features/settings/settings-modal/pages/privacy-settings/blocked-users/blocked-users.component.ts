 ...
 *
 * <p>Blocking itself happens where people are - profile cards, member lists, message context
 * menus. This is the place it can be undone, which is the half a user cannot reach any other way
 * once the blocked person is no longer visible to them.</p>
 */
@Component({
