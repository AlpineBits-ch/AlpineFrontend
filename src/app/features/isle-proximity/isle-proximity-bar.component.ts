...
export class IsleProximityBarComponent implements OnInit, OnDestroy {
    ...
    protected readonly visible = computed(() => this.prox.isGameConnected() || this.prox.isVoiceActive());

    protected readonly mode = computed<BarMode>(() => {
    ...
    protected readonly pttKey = signal('');
    ...
    protected readonly hintKind = computed<'none' | 'ptt' | 'mute'>(() => {
