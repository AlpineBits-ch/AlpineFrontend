 ...
 *
 * <p>Both are conditional on things a screenshot will not catch. The admin row is invisible to
 * almost every account, and the accounts card swaps between a submenu and a plain button depending
 * on a registry that is empty in every fresh installation - so the common path through this
 * component is the one least likely to be exercised by hand.</p>
 */
