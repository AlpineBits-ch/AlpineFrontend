...
describe('isWithinQuietHours', () => {
    ...
    it('follows the zone through DST rather than a fixed offset', () => {
        // Zurich is UTC+1 in January and UTC+2 in July. 21:30 UTC is 22:30 local in January
        // (inside) and 23:30 local in July (also inside); 20:30 UTC is 21:30 local in January
        // (outside) and 22:30 local in July (inside). The July case is the one a cached winter
