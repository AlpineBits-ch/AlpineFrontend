...
/**
 * Whether the hierarchy lets this role be dragged.
 *
 * <p>@everyone owns position 0 and nothing else may hold it; a managed role's position is fixed
 * because the reorder endpoint refuses to be told about it at all.</p>
 */
