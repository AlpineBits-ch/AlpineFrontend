...
function render(room: RoomState = {}) {
    ...
    TestBed.configureTestingModule({
        providers: [
            // No translations loaded, so every key echoes itself, which is what lets an assertion name the key the component chose rather than a sentence somebody may reword.
