/** The participant row's `watch` is forwarded with the channel-scoped userId - see Task 3. */
...
function render(
    ...
    TestBed.configureTestingModule({
        ...
        providers: [
            ...
            // Drag/drop plumbing is irrelevant to watch forwarding - only its DI token needs
            // satisfying, since the component injects it directly rather than through providers.
