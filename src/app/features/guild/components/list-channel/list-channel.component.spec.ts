...
describe('ListChannelComponent', () => {
    ...
    it('offers "clear done" only with ManageLists', () => {
        // Scoped to the header: the per-row delete button shares the glyph, and AddListItems does
        // grant that one for your own rows - it is only the *list-wide* clear that needs ManageLists.
