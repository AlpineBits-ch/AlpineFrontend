 ...
 * The `[[` page picker.
 *
 * Reuses the same ranking as the command palette so "[[set" and a ⌘K search for "set" surface
 * pages in the same order - two different orders for the same query reads as a bug.
 */
@Component({
