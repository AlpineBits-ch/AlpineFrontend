...
/**
 * The wiki's front door: built around the one thing that is only here (what has changed, and who
 * changed it), with counts and the category overview in a side column for orientation.
 */
@Component({
...
export class WikiHomeComponent {
    ...
    /** Opens the ask panel. Ungated: asking the wiki a question is reading, not editing. */
