...
describe('isTypingTarget', () => {
    ...
    // Read mode is the same ProseMirror element with contenteditable="false", and it is exactly where `e` has to work; a check for "is the editor" instead of "is editable" would make the shortcut it exists for impossible.
