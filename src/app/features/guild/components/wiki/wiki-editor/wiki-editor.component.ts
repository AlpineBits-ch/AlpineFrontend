...
export class WikiEditorComponent implements AfterViewInit, OnDestroy {
    ...
    protected toggleTaskList(): void {
        this.tiptapEditor?.chain().focus().toggleTaskList().run();
    }
    ...
    protected insertHR(): void {
        this.tiptapEditor?.chain().focus().setHorizontalRule().run();
    }
