...
describe('splitAnswer', () => {
    ...
    // An ordinary external link is not a citation, and rendering it as one would produce a
    // button that navigates to a page id that does not exist.
...
describe('buildAskQuestion', () => {
    ...
    // A turn that failed or was stopped has no answer; including it would present the model with
    // a question it is being told it already answered, and no answer.
...
describe('rankAskSources', () => {
    ...
    // The trimming happens in the provider layer, which prefers whole pages; truncating here
    // would both truncate twice and defeat that preference.
