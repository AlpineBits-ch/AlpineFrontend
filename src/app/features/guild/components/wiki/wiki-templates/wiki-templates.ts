 ...
 *
 * Chosen from what community wikis actually repeat rather than from what a wiki could hold: the
 * same eight or nine shapes account for most pages anybody writes here, and every one of them
 * currently starts as a blank document.
 *
 * Blank is first on purpose. It is the escape hatch, and burying it behind eight cards would make
 * the picker feel like a toll gate on page creation.
 */
