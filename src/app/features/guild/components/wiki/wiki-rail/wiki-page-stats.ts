 ...
 *
 * Counts prose, not markup: a page whose body is mostly link targets and table pipes is not the
 * twenty-minute read the raw character count claims. Pure and separate from the rail so the
 * stripping rules can be tested without a component.
 */
...
/**
 * Markdown reduced to the text a reader actually reads.
 *
 * Code inside a fence stays - it is content somebody has to read - but the fence markers, image
 * syntax, link targets and emphasis characters go, because none of them is a word.
 */
