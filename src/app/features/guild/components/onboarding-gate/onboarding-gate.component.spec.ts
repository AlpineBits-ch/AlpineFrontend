...
async function setup(status: OnboardingStatus = statusFixture()) {
    TestBed.configureTestingModule({
        ...
        providers: [
            ...
            // The real store reaches GuildWebsocketService -> AuthService -> OAuthService,
            // none of which this screen needs. Option emoji resolution is the only thing
            // it's used for here, and no fixture exercises a custom emoji.
...
describe('OnboardingGateComponent', () => {
    ...
    /**
     * A member who joined while onboarding was on and had it disabled under them keeps
     * completed: false forever - gating on that alone would strand them here.
     */
