...
/**
 * Coarse "2 hours ago" phrasing, localised off the active language. Pure, so pass a ticking signal
 * as the second argument (`| relativeTime: now()`) wherever the text needs to stay live.
 */
