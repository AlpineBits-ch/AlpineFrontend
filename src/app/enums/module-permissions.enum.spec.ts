...
/**
 * The bit numbers are the contract with `Guild.Domain/Enums/ModulePermissions.cs`, and the
 * migration that moved these out of the core mask used exactly this table. A number that drifts
 * here reinterprets every mask ever stored, silently.
 */
