 ...
 * Everything here guards the one mistake that costs nothing at compile time and everything at
 * runtime: reading one space with the other's parser.
 */
describe('the two permission spaces', () => {
    ...
    // rather than as a different permission. That is the property worth having.
