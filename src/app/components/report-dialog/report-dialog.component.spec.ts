...
async function setup() {
    ...
    await TestBed.configureTestingModule({
        ...
        providers: [
            ...
            // The stores' dependency chains reach MlsService and Tauri plugins, unusable under jsdom.
...
describe('ReportDialogComponent dismissal', () => {
    ...
    it('closes on escape from the confirmation stage', async () => {
        ...
        // The component keeps its state protected, so reach it through a narrow structural cast.
