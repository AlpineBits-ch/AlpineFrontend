...
describe('UserStatusDotComponent', () => {
    ...
    // ── Silhouettes ─────────────────────────────────────────────────────────
    // Hue alone fails a colour-blind reader, and fails everyone at the 10px
    // these are drawn at. Each status gets a shape as well.
    ...
    /**
     * The notch a silhouette opens shows the outer element. Without an opaque backing there it
     * would show whatever the dot is sitting on - which is an avatar, and a crescent with a face
     * in the bite is not a crescent.
     */
