...
describe('ServerClockService', () => {
    ...
    /**
     * The reading is taken after a round trip, so charging the whole trip to the offset would make
     * a slow request look like a clock error. Halving it is the NTP assumption and the reason a
     * 2 s request does not move the answer by 2 s.
     */
