...
export class VoiceChannelService {
  ...
  getVideoStream(userId: string):  MediaStream | null { return this.rtc.getVideoStream(userId); }
  getScreenStream(userId: string): MediaStream | null { return this.rtc.getScreenStream(userId); }
