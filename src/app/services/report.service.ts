...
/**
 * Filing reports, and reading back what came of them.
 *
 * <p>Addressed through {@link ApiConfigService} rather than `environment.apiUrl`: the account in
 * the active slot may be on a self-hosted server, and a report has to reach the moderators of the
 * instance the reported content is on.</p>
 */
...
export class ReportService {
     ...
     * Files a report.
     *
     * <p>A `merged: true` in the response means this folded into a report the same user already
     * filed against the same subject within 24 hours. Callers must say so rather than showing a
     * second "Report submitted".</p>
     */
