...
describe('ShareWatchService', () => {
    ...
    it('stops watching a share that left the screen', () => {
        // Maximising one stream stops the others being rendered - their streamers should stop
    ...
    it('keeps renewing after a failed announcement', () => {
        // A watch refused because the roster had not caught up yet must not silently give up -
        // the claim stays local so the next beat retries.
