...
export class GuildSafetyService {
    ...
    /**
     * Idempotent: accepting twice is a no-op and does not re-apply responses. A JSON body is
     * mandatory even with no prompts, or the model binder rejects the request.
     */
    ...
    /**
     * Full replace across all prompts, never a delta: an omitted prompt reads as "nothing selected"
     * and its grants are revoked.
     */
