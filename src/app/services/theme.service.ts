...
export class ThemeService {
    ...
    /**
     * Writes the theme out as JSON, wherever the host puts saved files. Resolves whether or not
     * anything was written. The `.json` in the suggested name drives the save dialog's file-type
     * filter, so it is load-bearing.
     */
    ...
    private saveThemes(): void {
        // Don't persist the built-in theme; it is always loaded from DEFAULT_THEME.
