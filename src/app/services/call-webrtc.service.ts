...
export class CallWebRtcService {
    ...
    private startEngine(
        ...
        // not yet grown the parameter - and that cast is what turns "forgot the connection" from a
        // compile error into a 404 three layers down inside Rust. The connection is a typed argument
        // rather than ambient state precisely so the omission is unbuildable; a cast here gives away
