...
export class ProfileService {
    ...
    public readonly ownProfile = signal<ProfileDto | undefined>(undefined);
    private httpClient = inject(HttpClient);
    // Two indexes into the same profiles -whichever key you have, you can look up
    private readonly byProfileId = signal<Record<string, ProfileDto>>({});
    private readonly byUserId = signal<Record<string, ProfileDto>>({});
