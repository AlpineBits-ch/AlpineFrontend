/** `version()` is stamped into the key-backup envelope, so it must be empty on failure and never a fallback. */
...
describe('AppInfoService', () => {
    ...
    /** Nothing may render "undefined" while the host is still being asked: the port is async on both hosts. */
